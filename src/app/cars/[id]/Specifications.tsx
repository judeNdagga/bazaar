          ...
          <div className="flex justify-center">
            <div className="grid sm:grid-cols-1 xl:grid-cols-3 gap-16">
              ...
              <div className="w-64 h-48 space-y-4">
                ...
                <div>
                  <h1>DIMENSIONS</h1>
                  <p className="font-light">Dimensions (Lxwxh) in mm : 4795 x 1855 x 1835</p>
              ...
              <div className="w-64 h-48 space-y-4">
                ...
                <div>
                  <h1>WARRANTY</h1>
                  <p className="font-light">Manufacturer Warranty : 3 years / 100 000 Km</p>
              ...
              <div className="">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="btn bg-slate-900 text-gray-200"><BookATestDrive/></div>
                </div>
              </div>
            </div>
            {/* cars picture */}
