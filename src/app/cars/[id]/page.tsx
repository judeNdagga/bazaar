...
export default async function CarPage({ params: { id } }: CarPageProps) {
  ...
  return (
    ...
    <div className="bg-white">
      {/* Car Name */}
      <div className="">
        <h1 className="text-sm ml-[45%] mt-[16%] font-bold tracking-widest absolute z-40 text-white">
          THE 2024 MITSUBISHI
        </h1>
        <h1 className="text-5xl font-bold ml-[24%] mt-[19%] absolute z-40 text-white uppercase">
          {car.name}
        </h1>
        <h1 className="text-2xl ml-[35%] mt-[26%] absolute z-40 text-white">
          Wherever you go, go boldly, comfortably, and in style.
        </h1>
        <button className="inline-flex absolute z-40 h-12 w-[15em] hover:w-[16em] ml-[43%] mt-[32%] transition-all duration-300 animate-shimmer items-center justify-center rounded-md border-2 border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-white hover:text-red-300 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 focus:ring-offset-red-200">
