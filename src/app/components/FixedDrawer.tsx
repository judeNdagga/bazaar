...
export default function FixedDrawer() {
  return (
    <motion.div className="fixed top-[33%] text-white grid grid-cols-1 gap-2 text-3xl right-0"
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    ...
    >
      ...
      className="dropdown dropdown-hover bg-black pt-4 dropdown-left">
        ...
        <li
          ...
          className="dropdown-content z-[1] menu rounded-box w-44"
        >
          <a href="../Dealerships" className="bg-black text-[0.7rem] hover:bg-white hover:text-black">
            Find a Dealer
          </a>
        </li>
      </motion.div>
