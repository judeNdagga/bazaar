...
export default function BookATestDrive() {
  ...
  async function addTestDrive(formData: FormData) {
    ...
    const response  = await axios.post(apiEndPoint+'/bookings/test-drive/', post);
...
<Modal blockScrollOnMount={false} isOpen={isOpen} onClose={onClose}>
  <ModalOverlay />
  <ModalContent>
    <ModalHeader className='bg-slate-900 text-white text-center'>Book A Test Drive</ModalHeader>
    <ModalCloseButton />
